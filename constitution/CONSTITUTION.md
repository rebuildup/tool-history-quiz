# tool-history-quiz Constitution

この文書は、tool-history-quiz の開発組織における最上位 contract です。
...
tool-history-quiz の開発組織の目的は current procedure への服従ではありません。
...
This repository owns the history-quiz tool source. my-web-2025 and its shared UI package remain separate authorities. A sibling host checkout may be required for full integration evidence, but that does not transfer source ownership.

## Upstream source

Governance was reconciled from `rebuildup/project-init@release-0-3-0` (`57fb4a2e5abe6f52e4fd9cb2cb88234496e47d4b`). Agent Skills are not frozen to that revision; they track current project-init through the project-local Skills CLI.
